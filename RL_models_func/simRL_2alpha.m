function stats = simRL_2alpha(stats, xpar)
%% simRL_ %%
    ...
    if stats.currTrial == 1  %if this is the first trial
        ...
        if stats.c(T-1)==-1   % if chose Option1 on the previous trial
            ...
            if stats.rpe(T-1) > 0
                ...
                stats.q1(T) = stats.q1(T-1) + alphaP*stats.rpe(T-1);
            else
                % Negative RPE: update w/ alpha-
                stats.q1(T) = stats.q1(T-1) + alphaM*stats.rpe(T-1);
            end
        ...
        elseif stats.c(T-1)==1   % else, chose Option2
            ...
            if stats.rpe(T-1) > 0
                stats.q2(T) = stats.q2(T-1) + alphaP*stats.rpe(T-1);
            else
                stats.q2(T) = stats.q2(T-1) + alphaM*stats.rpe(T-1);
            end
